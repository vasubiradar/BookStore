...
User Authentication: Secure login and registration. Book Catalog: Browse and search for books. Shopping Cart: Add books to the cart and proceed to checkout. Secure Payment: Process payments through secure APIs. Responsive Design: Optimized for both desktop and mobile devices.

Technologies Used

Front End: ReactJS, CSS Back End: Spring MVC Database: MySQL API Testing: Postman
