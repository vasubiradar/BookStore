...
const ShoppingCart = ({ onIncrement, onDecrement, onDelete,isAuthenticated  }) => {
        ...
        <div className="row no-gutters">
          ...
          <div className="card  col-md-3  mx-auto">
            ...
            <div className="card-footer border-secondary bg-transparent">
              ...
              <button onClick={openPaymentModal} className="btn btn-block btn-warning">
        Proceed To Checkout
      </button>
     {/* Feedback button */}
     <button onClick={handleOpenFeedbackForm} className="btn btn-block btn-warning">
            Feedback
          </button>
            </div>
          </div>
      ...
      {showPayment && (
        <div className="modal">
          <div className="modal-content">
            <span className="close" onClick={handleClosePayment}>
              &times;
            </span>
            <Payment />
          </div>
